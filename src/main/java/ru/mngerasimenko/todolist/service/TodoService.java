...
public interface TodoService {
     ...
     * Здесь же проверяется FeatureFlag#TODO_REMINDER_EMAIL — гейт канала писем: при
     * выключенном флаге напоминание уходит только push'ом, а токен отписки не выпускается.
     */
